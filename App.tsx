      ...
      <div className="md:hidden min-h-screen bg-[#f4f6f8] flex flex-col font-sans">
        ...
        <div className="w-full max-w-[400px] mx-auto flex flex-col py-6 px-5">
          ...
          <div className="mb-8 w-full text-center">
            <div className="flex justify-center items-center mb-4 mt-2">
              <div className="flex items-center gap-[8px]">
                <svg width="35" height="35" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
          ...
          <div className="w-full bg-white rounded-[20px] border border-slate-200 shadow-sm overflow-hidden mb-8">
            <ul className="flex flex-col">
              {steps.map((step, index) => (
                ...
                >
                  <div className="flex-shrink-0 w-[28px] h-[28px] rounded-full bg-[#cc0000] text-white flex items-center justify-center font-bold text-[13px] select-none">
                    {step.id}
                  </div>
          ...
          <div className="w-full flex flex-col items-center mb-8">
            <button 
              onClick={() => {
                const url = 'https://giftclick.org/aff_c?offer_id=1178&aff_id=144760';
                window.location.href = url;
              }}
              className="block w-full text-center bg-[#cc0000] hover:bg-[#a30000] text-white font-bold text-[22px] py-[16px] rounded-[10px] transition-all duration-200 shadow-[0_15px_30px_-5px_rgba(204,0,0,0.5)] cursor-pointer select-none"
            >
              Claim Your Reward
            </button>
